...
\pandocbounded{\includegraphics[keepaspectratio]{Unidad2_files/figure-pdf/unnamed-chunk-7-1.pdf}}
...
\subsection{Cuidado con la
parametrización}\label{cuidado-con-la-parametrizaciuxf3n}

\begin{itemize}
\tightlist
\item
  Las distribuciones \textbf{Weibull}, \textbf{Gamma},
  \textbf{Log-normal}, etc., se usan comúnmente para modelar tiempos de
  vida.
\item
  Cada una tiene formas \textbf{teóricas} bien definidas.
\item
  ...
  \tightlist
  \item
    La \textbf{parametrización puede cambiar}.
  \item
    Es crucial revisar la \textbf{documentación oficial}
    (\texttt{?dweibull}, \texttt{?dgamma}, etc.)
  \end{itemize}
\end{itemize}

\begin{figure}[H]

{\centering \pandocbounded{\includegraphics[keepaspectratio]{figura/Funciones1.png}}
...
\subsection{Weibull: teoría vs.~R}\label{weibull-teoruxeda-vs.-r}
...
\pandocbounded{\includegraphics[keepaspectratio]{Unidad2_files/figure-pdf/unnamed-chunk-10-1.pdf}}
