...
## Ejemplos prácticos {.smaller transition="fade"}
...
## 2. Funciones fundamentales en análisis de supervivencia {.scrollable transition="slide"}
...
::: {.column width="45%"}
_Aplicación típica_: pruebas de resistencia de equipos que se detienen al fallar cierto número de unidades.
...
> Adolescente declara:  
> _“Sí consumí marihuana, pero no recuerdo cuándo”._  
...
::: {.column width="45%"}
_Imaginemos una ventana de observación:_  
