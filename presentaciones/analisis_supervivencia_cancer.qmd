...
modelo_cox3 <- coxph(Surv(tiempo, muerte) ~ trat * edad, data = datos)
summary(modelo_cox0)
summary(modelo_cox1)
summary(modelo_cox2)
summary(modelo_cox3)
